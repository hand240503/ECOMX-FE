      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2 text-center">
            {currentStep === 'email' && 'Nhập thông tin liên hệ'}
            {currentStep === 'otp' && 'Xác thực tài khoản'}
            {currentStep === 'password' && 'Tạo mật khẩu'}
          </h2>
          <p className="text-sm text-gray-500 mb-6 text-center">
            {currentStep === 'email' && 'Nhập email hoặc số điện thoại để bắt đầu'}
            {currentStep === 'otp' && 'Nhập mã xác thực đã được gửi'}
            {currentStep === 'password' && 'Tạo mật khẩu cho tài khoản của bạn'}
          </p>
                ...
                <div>
                  ...
                  {emailOrPhone && !emailOrPhoneError && (
                    <p className="mt-1 text-xs text-green-600">
                      {inputType === 'email' && '✓ Email hợp lệ'}
                      {inputType === 'phone' && '✓ Số điện thoại hợp lệ'}
                    </p>
                  )}
                </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Bằng việc đăng ký, bạn đã đồng ý với ECOMX về
          </p>
