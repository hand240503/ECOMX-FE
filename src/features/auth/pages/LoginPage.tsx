          ...
          {activeTab === 'password' && (
            <form onSubmit={handleLogin} className="space-y-4" noValidate>
              ...
              <div>
                ...
                {login && !emailError && (
                  <p className="mt-1 text-xs text-gray-500">
                    {inputType === 'email' && 'Dang nhap duoi dang email'}
                    {inputType === 'phone' && 'Dang nhap duoi dang so dien thoai'}
                    {inputType === 'username' && 'Dang nhap duoi dang ten dang nhap'}
                  </p>
                )}
              </div>
              ...
              <div className="text-center mt-6">
                <span className="text-sm text-gray-600">Ban moi biet den ECOMX? </span>
          ...
          {activeTab === 'qr' && (
            <div className="flex flex-col items-center py-8">
              ...
              <p className="text-sm text-gray-600 text-center">
                Mo ung dung ECOMX va quet ma QR de dang nhap
              </p>
            </div>
          )}
        </div>
